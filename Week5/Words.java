...
//        System.out.println("length4:" + length4);
        ...
        // Output word1 and the length of word1 and the position
        // of all the vowels (a, e, i, o, u) in word1
        System.out.println("Word1 = \"" + word1 + "\" Length = " + length1 +
                " position of vowels: 'a' = " + word1PosA +
                ", 'e' = " + word1PosE +
                ", 'i' = " + word1PosI +
                ", 'o' = " + word1PosO +
                ", 'u' = " + word1PosU);
        System.out.println("Word2 = \"" + word2 + "\" Length = " + length2 +
                " position of vowels: 'a' = " + word2PosA +
                ", 'e' = " + word2PosE +
                ", 'i' = " + word2PosI +
                ", 'o' = " + word2PosO +
                ", 'u' = " + word2PosU);
        System.out.println("Word3 = \"" + word3 + "\" Length = " + length3 +
                " position of vowels: 'a' = " + word3PosA +
                ", 'e' = " + word3PosE +
                ", 'i' = " + word3PosI +
                ", 'o' = " + word3PosO +
                ", 'u' = " + word3PosU);
        System.out.println("Word4 = \"" + word4 + "\" Length = " + length4 +
                " position of vowels: 'a' = " + word4PosA +
                ", 'e' = " + word4PosE +
                ", 'i' = " + word4PosI +
                ", 'o' = " + word4PosO +
                ", 'u' = " + word4PosU);
